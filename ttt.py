...
→  Owner      :   JAMil
→  Facebook   :  VISAL KING
→  Github     :  KING JAMIL AHMAD
→  Tools      :  RANDOM 
\33[1;32m→  Version    :  9.5
\33[1;37m-----------------------------------------------------------""")
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      tks = ('Hello%20khalid%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+93708509223?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
